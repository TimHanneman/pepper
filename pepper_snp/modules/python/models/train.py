        ...
        with transducer_model.train():
            for images, labels in train_loader:
                ...
                for i in range(0, ImageSizeOptions.SEQ_LENGTH, TrainOptions.WINDOW_JUMP):
                    ...
                    #####################
                    ###################
                    #This in terms of training is the first thing that you do. It calls the forward method, sends image_chunk, and hidden
                    #Need to add cell state to the neural network
                    #Do the same to train
                    output_, hidden = transducer_model(image_chunk, hidden)
                    #output_, hidden = transducer_model(image_chunk, hidden, cell_state)
